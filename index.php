    ...
    <main>
        ...
        <div class="produtos">
            ...
            <!-- <div class="rowProd">
                ...
                <div class="prod" onclick="window.location.href = './splash.html'">
                    <div class="img">
                        <img src="./camisas/camisetaAzulEscuro.webp" id="img1" width="75%" alt="">
                    </div>
                    <div class="txt">Camiseta azul escuro muito bonita e legal para você comprar agora meu querido</div>
                </div>

                <div class="prod" onclick="window.location.href=''">
                    <div class="img">
                        <img src="" id="img2" alt="">
                    </div>
                    <div class="txt"></div>
