...
<div class="img1">
    <img src="../produtos_user/<?php echo $imagem1; ?>" alt="Imagem 1"></div>
            ...
            <div class="vendaProduto">
                ...
                <div class="price-wrapper">
                    ...
                    <div class="price-container">
                        <span class="old-price">DE R$ <?php print number_format($preco, 2); ?></span>
                        <div class="price-details">
                            <span class="current-price">R$ <?php print number_format($preco-$preco_com_desconto, 2); ?> <span class="discount"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down-short" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M8 4a.5.5 0 0 1 .5.5v5.793l2.146-2.147a.5.5 0 0 1 .708.708l-3 3a.5.5 0 0 1-.708 0l-3-3a.5.5 0 1 1 .708-.708L7.5 10.293V4.5A.5.5 0 0 1 8 4"/>
                              </svg> <?php print $desc*100; ?> %</span></span>
                        </div>
                        <div class="buttons">
                            <span class="installments">Em até 12x de R$ <?php print number_format($preco_com_desconto/12, 2); ?></span>
                            <div class="smaller-button">R$ <?php print number_format($preco*$desc, 2); ?> de desconto</div>
                ...
                <span class="estoque">36 unidades disponiveis</span>
                </div>
